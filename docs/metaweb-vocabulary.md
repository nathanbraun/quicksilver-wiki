...
The **junior high school level** (3000-5000 words) has been mentioned (by [Neal](/user-nealstephenson)) as an eventual [reading level](/reading-level) target. See [Simple English Editor role outline at Simple English Wikipedia](https://simple.wikipedia.org/wiki/simple-english-editor) for a list of what one might need to know before setting a vocabulary level.
