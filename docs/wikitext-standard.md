...
There is [an effort towards this starting at Meta-Wikipedia](https://meta.wikipedia.org/wiki/wikitext-standard). This may eventually relieve the dependence on [mediawiki](/mediawiki) and let other suites such as [tikiwiki](/tikiwiki) or [MoinMoinWiki](/moinmoinwiki) be used, or entirely new programs to develop to manipulate the [Metaweb](/metaweb).

See ['linguistic democracy'](https://meta.wikipedia.org/wiki/linguistic-democracy-in-a-multilingual-project), [wikitext DTD](https://meta.wikipedia.org/wiki/wikitext-dtd), [Wikipedia DTD](https://meta.wikipedia.org/wiki/wikipedia-dtd), ['simple ideology of Wikitax'](https://meta.wikipedia.org/wiki/simple-ideology-of-wikitax), [(wiki) talk media](https://meta.wikipedia.org/wiki/talk-media), and other comments and proposals linked from there, if you wish to contribute to the Wikipedia-centric discussion.
...
[The first useful map](https://meta.wikipedia.org/wiki/the-first-useful-map) generated automatically from Wikipedia's geographic tags is also evidence that it sets standards in the GIS area that will probably be adopted by other mediawiki projects including [Metaweb](/metaweb).
