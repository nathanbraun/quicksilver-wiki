...
A model is formally defined in context of some language L, following [Tarski](https://en.wikipedia.org/wiki/alfred-tarski)'s concept of truth. The model consists of two things: 
...
* **[Löwenheim-Skolem theorem](https://en.wikipedia.org/wiki/löwenheim-skolem-theorem)**
