...
Why would anyone have to do that? In real world systems where anyone can have a say, there are tendencies, parties, factions, and all of [politics as usual](https://en.wikipedia.org/wiki/politics). If you argue that in a big wiki with equally broad participation that these things aren't necessary, the onus is on you to prove why that would be so.  

If you hate the word [faction](https://en.wikipedia.org/wiki/faction), then use Neal's word and call this a [Metaweb:phyle](/metaweb-phyle)...  
...
In [Diamond Age](/diamond-age), education is [factionally](https://en.wikipedia.org/wiki/faction) [defined](https://en.wikipedia.org/wiki/definition) and controlled, very clearly. Each [phyle](/phyle) has its own way of doing it. If you aren't willing to copy Stephenson's model quite closely, then, what are we doing here? And if you think there is politically neutral education, you are really quite alone. I can't think of a single educational theorist that would say more than that you are trying to honestly reflect the civilization's values, with some shaping towards its ideals, in education. It is never in any way culturally neutral.  
...
1. ***[Education](https://en.wikipedia.org/wiki/education) is [neutral](https://en.wikipedia.org/wiki/neutral) when done right*** is an **[axiom](https://en.wikipedia.org/wiki/axiom)**.
2. [Kids](https://en.wikipedia.org/wiki/adolescence) [understand](https://en.wikipedia.org/wiki/understanding) the concept of [bias](https://en.wikipedia.org/wiki/bias) and [balance](https://en.wikipedia.org/wiki/balance). [They](https://en.wikipedia.org/wiki/young-adult) can [SMELL](https://en.wikipedia.org/wiki/olfaction) [pressure](https://en.wikipedia.org/wiki/tactition).
3. Therefore, if informed, an education will be neutral and without *[political](https://en.wikipedia.org/wiki/politics)* pressuring. IE  I would go to summer school at a Boy's Religious School during 8th and 9th grade. I had to deal with religious promotional pressure from teachers. I didn't share their religion and resisted. It gave me good training in dealing with evangelists later. All my peers share similar political views though we participate via different parties.
