...
Daniel's scheme is suspicously similar to the technique used by **[Kurt Gödel](https://en.wikipedia.org/wiki/kurt-gödel)** in his [Incompleteness Theorem](https://en.wikipedia.org/wiki/gödel-s-incompleteness-theorem). And given [Daniel Waterhouse](/daniel-waterhouse)'s links to computational machinery and later discussions with [Leibniz](/leibniz), this is not a coincidence. ![KurtGodel.jpg](/https://web.archive.org/web/20060725170450im_/http://upload.wikimedia.org/wikipedia/nl/7/70/KurtGodel.jpg)  
**Kurt Gödel  
...
Try [Gödel Escher Bach](http://www.amazon.com/exec-obidos-tg-detail-0465026567-104-8179311-5812717-v-glance) by [Hofstadter](https://en.wikipedia.org/wiki/douglas-hofstadter) for an entertaing and enlightening, if potentially difficult, introduction to Minds, Machines, and Gödel.

### [Gödel, Escher, Bach](https://en.wikipedia.org/wiki/gödel-escher-bach)


***Gödel, Escher, Bach: an Eternal Golden Braid*** is a [Pulitzer Prize](https://en.wikipedia.org/wiki/pulitzer-prize)-winning book by [Douglas Hofstadter](https://en.wikipedia.org/wiki/douglas-hofstadter), first published in 1979 by Basic Books.

At one level, it is a book about how the creative achievements of [logician](https://en.wikipedia.org/wiki/logic) [Kurt Gödel](https://en.wikipedia.org/wiki/kurt-gödel), [artist](https://en.wikipedia.org/wiki/artist) [M. C. Escher](https://en.wikipedia.org/wiki/m-c-escher) and [composer](https://en.wikipedia.org/wiki/composer) [Johann Sebastian Bach](https://en.wikipedia.org/wiki/johann-sebastian-bach) interweave. As the author states: "I realized that to me, Gödel and Escher and Bach were only shadows cast in different directions by some central solid essence. I tried to reconstruct the central object, and came up with this book."
...
The book takes the form of an interleaving of various narratives. The main chapters alternate with dialogues between imaginary characters, inspired by [Lewis Carroll](https://en.wikipedia.org/wiki/lewis-carroll)'s "[What the Tortoise Said to Achilles](https://en.wikipedia.org/wiki/what-the-tortoise-said-to-achilles)", which features in the book. In this, [Achilles](https://en.wikipedia.org/wiki/achilles) and the Tortoise discuss a paradox related to *[modus ponens](https://en.wikipedia.org/wiki/modus-ponens)*. Hofstadter bases the other dialogues on this one, introducing the Crab and a Genie, among others.

[Word play](https://en.wikipedia.org/wiki/word-play) features prominently: the initials of the four main dialog characters are G, C, A, and T -- the base-pairs in [DNA](https://en.wikipedia.org/wiki/dna). Some puns may be found quite atrocious, but forgivable for the breadth of the connection they make between ideas: "the MagnifiCrab, Indeed" (Bach's *Magnificat in D*), "[SHRDLU](https://en.wikipedia.org/wiki/shrdlu), Toy of Man's Designing" (Bach's *Jesu, Joy of Man's Desiring*), and "Typographical Number Theory", which inevitably reacts explosively when it attempts to make statements about itself, thus "[TNT](https://en.wikipedia.org/wiki/trinitrotoluene)".

TNT is an illustration of [Gödel's incompleteness theorem](https://en.wikipedia.org/wiki/gödel-s-incompleteness-theorem) and further analogies for it occur in the book, for example a phonograph which destroys itself by playing a record entitled "I Cannot Be Played on Record Player X". This is an example of a [strange loop](https://en.wikipedia.org/wiki/strange-loop), a term coined by Hofstadter to describe things which speak about or refer back to themselves, such as Escher's lithograph of two hands drawing each other.

There are other colorful stories about SHRDLU, the Alternative State of the Union, self-engulfing TV screens, [canonical](https://en.wikipedia.org/wiki/canon-music) form in [music](https://en.wikipedia.org/wiki/music). Other topics range from [Zeno's paradoxes](https://en.wikipedia.org/wiki/zeno-s-paradoxes) to sentient ant colonies. A key question asked by the book is "When are two things the same?"

The book has been translated into several languages. Since parts of the book are about language and translation, translating the work itself has resulted in new material and interplay between the translators and Hofstadter; see the French edition for example. Some material regarding this interplay is to be found in Hofstadter's later book *[Le Ton beau de Marot](https://en.wikipedia.org/wiki/le-ton-beau-de-marot)*, which is mainly about translation.
...
* [Incompleteness Theorem](https://en.wikipedia.org/wiki/gödel-s-incompleteness-theorem)
...
* [strange loops](https://en.wikipedia.org/wiki/strange-loops)
* [A.I.](https://en.wikipedia.org/wiki/artificial-intelligence)
* [Rudy Rucker](https://en.wikipedia.org/wiki/rudy-rucker)
* [formal systems](https://en.wikipedia.org/wiki/formal-systems),
* [computability](https://en.wikipedia.org/wiki/computability-theory)
* [paradoxes](https://en.wikipedia.org/wiki/paradox)
...
* [Rene Magritte](https://en.wikipedia.org/wiki/rene-magritte)
* [brain](https://en.wikipedia.org/wiki/brain)
* [mind](https://en.wikipedia.org/wiki/mind)
* [free will](https://en.wikipedia.org/wiki/free-will)
* [determinism](https://en.wikipedia.org/wiki/determinism)
* [Charles Babbage](https://en.wikipedia.org/wiki/charles-babbage)
* [Alan Turing](https://en.wikipedia.org/wiki/alan-turing)
* [Tumbolia](https://en.wikipedia.org/wiki/tumbolia)
...
* [Douglas Hofstadter](https://en.wikipedia.org/wiki/douglas-hofstadter), *[Gödel, Escher, Bach](https://en.wikipedia.org/wiki/gödel-escher-bach)* ([ISBN 0465026567](/))
