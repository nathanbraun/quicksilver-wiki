...
Special Note: The Del symbol ("nabla;"), among others, is not supported on Windows 95 or 98. It has been uploaded as an image, and can be referenced as [[Image:Del.gif]], which looks like this: .
