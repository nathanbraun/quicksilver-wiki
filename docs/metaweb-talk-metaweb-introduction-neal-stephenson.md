...
[Simple English User Stories](https://simple.wikipedia.org/wiki/simple-english-user-stories) used to scope and guide the [Simple English Wikipedia](http://simple.wikipedia.org)

[List of Simple English Readings](https://simple.wikipedia.org/wiki/list-of-simple-english-readings), maybe an equivalent structure could "evolve" here?
...
This distinction is purely ideological, or at best [factionally defined](/factionally-defined). Some [Metaweb:factions](/metaweb-faction) will think some are merely open, others will think they are destined to remain empty, or are determined to keep them empty, e.g. to the Golds and Blues there is no "[proletariat](https://en.wikipedia.org/wiki/proletariat)", while to the Pinks and Reds there is no "[free trade](https://en.wikipedia.org/wiki/free-trade)". The North sees no "[overconsumption](https://en.wikipedia.org/wiki/overconsumtion)", the South sees no "[overpopulation](https://en.wikipedia.org/wiki/overpopulation)" Etc. And yes all these concepts were understood in the [Baroque](/baroque) era.
...
Not by you. These "many" are ultimately engaged in [thoughtcrime](https://en.wikipedia.org/wiki/nineteeneightyfour) - either identifying it or committing it. The view that some group is more suited to do editing than another because it owns the infrastructure, or is politically approved by same, is bankrupt morally. Trolls don't answer to it.
