...
[Spinoza](/spinoza)'s great work **Ethics** expounded his theories in [metaphysics](/metaphysics), [mereology](/mereology), [psychology](/psychology) and so on - in fact it was essentially a [Theory of Everything](https://en.wikipedia.org/wiki/theory-of-everything).

### Community entry: Ethics: [Sparky](/user-stsparky)


The Greeks claim to have coined the word from *Ethos* which meant *Moral Character*. To me that phrase has the same weight as [Leif Ericson](https://en.wikipedia.org/wiki/leifur-eiríksson) discovered [America](https://en.wikipedia.org/wiki/vinland) in the year 1000. It ignores a lot. *Proper behavior* has been *carved in stone* since [Code of Hammurabi](https://en.wikipedia.org/wiki/code-of-hammurabi), but that doesn't take into account traditional oral transmission of laws. A good example would be **[Talmud](https://en.wikipedia.org/wiki/talmud)** (התלמוד) is considered an authoritative record of rabbinic discussions on Jewish law, ethics, customs, legends and stories. It is a fundamental source of legislation, customs, case histories and moral exhortations. The Talmud comprises two components, the [Mishnah](https://en.wikipedia.org/wiki/mishnah) and the [Gemara](https://en.wikipedia.org/wiki/gemara).
